...
public:
    ...
    /** 返回3D模型结构 */
	t3DModel& getModel() { return _3DModel; }
...
private:
	...
	tMd2Header				_header;			         /**< 文件头 */
	tMd2Skin				*_pSkins;			         /**< 纹理数据指针 */
	tMd2TexCoord			*_pTexCoords;		         /**< 纹理坐标指针 */
	tMd2Face				*_pTriangles;		         /**< 三角形面指针 */
	tMd2Frame				*_pFrames;			         /**< 关键帧 */
	BMPLoader               _bmpTexture;                /**< 载入位图 */
	GLuint                  _textures[MAX_TEXTURES];    /**< 纹理数组 */
