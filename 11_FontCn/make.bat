...
:: warning LNK4217: 本地定义的符号 ___std_terminate
:: 用-flto-visibility-public-std or clang-cl
if %USE_CL% == 2 (
	clang -Xclang -flto-visibility-public-std  -D _CRT_SECURE_NO_WARNINGS -I "..\..\opengl1.1\include" -L "..\..\opengl1.1\lib" -l user32.lib -l gdi32.lib -o ..\main.exe *.cpp
)
